 ...
 */
// comment this out to execute exercises 1-8
// exercise 9 needs this to run
package chapter.pkg14.exercises;
...
public class Chapter14Exercises extends JApplet{
    ...
    private static JTextField txtInterval = new JTextField(10);
    ...
    public static void exercise9(String[] args) {
        if(ch9){
            ...
            bottom.add(filler2);
            bottom.add(filler3);
            frame.add(imgView, BorderLayout.CENTER);
